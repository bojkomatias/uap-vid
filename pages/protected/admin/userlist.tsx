            ...
            <div className="flex grow flex-col py-10 px-28 ">
                ...
                <div className="flex self-end">
                    <a
                        ...
                        className="flex items-center bg-base-100 p-4 font-bold text-primary transition-all duration-200 hover:scale-[102%] hover:bg-primary hover:text-white active:scale-[99%]"
                    >
                        <svg
