        ...
        <Headless.Transition appear show={open} {...props}>
            <Headless.Dialog onClose={onClose}>
                <Headless.TransitionChild
                    ...
                    leaveTo="opacity-0"
                >
                    <div className="fixed inset-0 flex w-screen justify-center overflow-y-auto bg-gray-950/15 px-2 py-2 focus:outline-0 dark:bg-gray-950/50 sm:px-6 sm:py-8 lg:px-8 lg:py-16" />
                </Headless.TransitionChild>
...
export function AlertTitle({
    ...
    return (
        <Headless.DialogTitle
            ...
            className={clsx(
                className,
                'text-balance text-center text-base/6 font-semibold text-gray-950 dark:text-white sm:text-wrap sm:text-left sm:text-sm/6'
            )}
        />
    )
}
