...
export function DescriptionList({
  ...
  return (
    <dl
      ...
      className={clsx(
        className,
        'grid grid-cols-1 text-base/6 @xl/dialog:grid-cols-[min(50%,theme(spacing.80))_auto] @3xl:grid-cols-[min(50%,theme(spacing.80))_auto] sm:text-sm/6 print:grid-cols-1'
      )}
    />
  )
}
