    ...
    >
      <Headless.Input
        ...
        className={clsx([
          ...
          // Basic layout
          'relative block w-full appearance-none rounded-lg px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing[3])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] print:text-right',
          // Typography
          'text-base/6 text-gray-950 placeholder:text-gray-500 dark:text-white sm:text-sm/6',
          // Border
          'border border-gray-950/10 data-[hover]:border-gray-950/20 dark:border-white/10 dark:data-[hover]:border-white/20 print:border-none',
          // Background color
