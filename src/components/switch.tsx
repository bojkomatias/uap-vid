...
const colors = {
  'dark/gray': [
    '[--switch-bg-ring:theme(colors.gray.950/90%)] [--switch-bg:theme(colors.gray.900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:theme(colors.white/25%)]',
    '[--switch-ring:theme(colors.gray.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white] dark:[--switch-ring:theme(colors.gray.700/90%)]',
  ],
  'dark/white': [
    '[--switch-bg-ring:theme(colors.gray.950/90%)] [--switch-bg:theme(colors.gray.900)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:theme(colors.white)]',
    '[--switch-ring:theme(colors.gray.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white] dark:[--switch-ring:transparent] dark:[--switch:theme(colors.gray.900)]',
  ],
  dark: [
    '[--switch-bg-ring:theme(colors.gray.950/90%)] [--switch-bg:theme(colors.gray.900)] dark:[--switch-bg-ring:theme(colors.white/15%)]',
    '[--switch-ring:theme(colors.gray.950/90%)] [--switch-shadow:theme(colors.black/10%)] [--switch:white]',
  ],
  gray: [
    '[--switch-bg-ring:theme(colors.gray.700/90%)] [--switch-bg:theme(colors.gray.600)] dark:[--switch-bg-ring:transparent]',
    '[--switch-shadow:theme(colors.black/10%)] [--switch:white] [--switch-ring:theme(colors.gray.700/90%)]',
  ],
  white: [
    '[--switch-bg-ring:theme(colors.black/15%)] [--switch-bg:white] dark:[--switch-bg-ring:transparent]',
    '[--switch-shadow:theme(colors.black/10%)] [--switch-ring:transparent] [--switch:theme(colors.gray.950)]',
  ],
  red: [
