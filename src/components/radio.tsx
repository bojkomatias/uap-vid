...
const base = [
    ...
    // Border
    'border border-gray-950/15 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-gray-950/30 group-data-[checked]:bg-[--radio-checked-border]',
...
const colors = {
    ...
    white: '[--radio-checked-bg:theme(colors.white)] [--radio-checked-border:theme(colors.gray.950/15%)] [--radio-checked-indicator:theme(colors.gray.900)]',
