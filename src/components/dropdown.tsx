...
export function DropdownItem({
  ...
  const classes = clsx(
    ...
    // Text styles
    'text-left text-base/6 text-gray-950 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]',
    // Focus
    'data-[focus]:bg-primary-950 data-[focus]:text-white',
    // Disabled state
    ...
    '[&>[data-slot=icon]]:text-gray-500 [&>[data-slot=icon]]:data-[focus]:text-white [&>[data-slot=icon]]:dark:text-gray-400 [&>[data-slot=icon]]:data-[focus]:dark:text-white',
    // Avatar
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr,auto] gap-x-12 px-3.5 pb-1 pt-2 text-sm/5 font-medium text-gray-500 dark:text-gray-400 sm:px-3 sm:text-xs/5'
      )}
    />
  )
}
...
export function DropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-gray-950/5 dark:bg-white/10 sm:mx-3 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-gray-500 group-data-[focus]:text-white dark:text-gray-400 sm:text-xs/5 forced-colors:group-data-[focus]:text-[HighlightText]'
      )}
    />
  )
}
    ...
    >
      {(Array.isArray(keys) ? keys : keys.split('')).map((char, index) => (
        <kbd
          key={index}
          className={clsx([
            'min-w-[2ch] text-center font-sans capitalize text-gray-400 group-data-[focus]:text-white forced-colors:group-data-[focus]:text-[HighlightText]',
