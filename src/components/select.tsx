    ...
    >
      <Headless.Select
        ...
        className={clsx([
          ...
          // Typography
          'text-base/6 text-gray-950 placeholder:text-gray-500 dark:text-white dark:*:text-white sm:text-sm/6',
          // Border
      ...
      {!multiple && (
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="size-5 stroke-gray-500 group-has-[[data-disabled]]:stroke-gray-600 dark:stroke-gray-400 sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
