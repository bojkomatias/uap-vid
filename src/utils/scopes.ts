...
const ROLE_SCOPE = {
    ...
    [ROLE.SECRETARY]: [ACCESS.PROTOCOLS, ACCESS.REVIEWS, ACTION.ACCEPT, ACTION.APPROVE_TO_REVIEW],
...
const STATE_SCOPE = {
    ...
    [STATE.PUBLISHED]: [ACTION.APPROVE_TO_REVIEW],
    [STATE.APPROVED_TO_REVIEW]: [ACTION.ASSIGN_TO_METHODOLOGIST],
