...
import { protocol, Role } from '@prisma/client'
...
export default function ReviewForm({ userRole, protocol }: { userRole: Role, protocol: protocol }) {
    ...
    return (
        <>   <CommentButton role={userRole} protocol={protocol} commentState={comment} action={() => { 
            setComment(!comment)
            form.clearErrors() }} />
            <div className="relative mb-2 z-50">
                <Transition show={comment}
