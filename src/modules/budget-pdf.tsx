          ...
          >
            <View>
              ...
              <View>
                ...
                >
                  <Text style={{ width: '40%' }}>Miembro</Text>
                  <Text style={{ width: '22%' }}>Horas semanales</Text>
                  <Text style={{ width: '22%' }}>Valor hora</Text>
                  <Text
                    style={{
                      width: '16%',
                      textAlign: 'right',
                ...
                <View>
                  ...
                  >
                    {budgetTeamMembers.map((member, idx) => {
                      return (
                        <View
                          key={idx}
                          style={{
              ...
              {budgetItems.length > 0 && (
                <>
                  ...
                  <View>
                    ...
                    >
                      <Text style={{ width: '80%' }}>Detalle</Text>
