...
const styles = {
    ...
    outline: 'text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50',
...
export const buttonStyle = (
    ...
    cx(
        'group flex items-center justify-center rounded-md px-4 py-2.5 text-sm transition duration-200 ease-out focus-visible:outline focus-visible:outline-[1.5px] focus-visible:outline-primary active:brightness-95 disabled:pointer-events-none disabled:opacity-75 disabled:saturate-50',
        styles[intent]
    )
