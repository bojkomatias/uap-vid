      ...
      <Document>
        ...
        >
          ...
          >
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Asignatura</Text>{' '}
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Carrera</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Equipo</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
          ...
          >
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Duración</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Modalidad</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
            ...
            >
              ...
              >
                {protocol.sections.duration.chronogram.map((crono, idx) => {
                  return (
                    <View
                      key={idx}
                      style={{
          ...
          >
            ...
            >
              ...
              >
                {protocol.sections.budget.expenses.map((gasto, idx) => {
                  return (
                    <>
                      <Text
                        key={idx}
          ...
          >
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Campo</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Educación</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
          ...
          >
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Estado</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
            ...
            >
              <Text style={{ color: 'gray', marginBottom: 4 }}>Objetivos</Text>{' '}
              <Text style={{ fontWeight: 600 }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ fontWeight: 600 }}>
                {protocol.sections.bibliography.chart.map((resource, idx) => {
                  return (
                    <Text key={idx}>
                      Título: {resource.title} | Autor: {resource.author} | Año:{' '}
                      {resource.year}
                    </Text>
                  )
                })}
